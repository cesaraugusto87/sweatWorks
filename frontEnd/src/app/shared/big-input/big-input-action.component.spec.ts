...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<sweatworks-big-input-action></sweatworks-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<sweatworks-big-input-action [disabled]="true"></sweatworks-big-input-action>';
    fixture = createHostComponent(template);
    expect(getButton().nativeElement.disabled).toBeTruthy();
  });

  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template = `<sweatworks-big-input-action fontSet="fas" fontIcon="fa-trash"></sweatworks-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template = `<sweatworks-big-input-action label="delete"></sweatworks-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template = `<sweatworks-big-input-action (action)="actionHandler()"></sweatworks-big-input-action>`;
    fixture = createHostComponent(template);
